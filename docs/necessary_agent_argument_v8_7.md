...
- (cz) The handoff's formal burden list is empty. What remains is philosophical: TR's content claim (III.5); IDF and profile uniformity (III.6); CatU's two premises (III.7); the problem of evil at P8/w₀.
