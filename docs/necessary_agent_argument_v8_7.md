...
**Changes from v8.10 (this revision — v8.11: III.4 rewritten; no Lean change).**
...
So the trilemma leaves two live positions for a genuine second fundamental: a bare source, priced as Exit 1, or a second necessary mind indiscernible from the first in every necessary respect.
